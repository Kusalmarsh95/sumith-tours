...
@section('content')
    ...
    <div class="about-main-content" style="background-image: url({{ asset('/images/snorkeling.jpg') }});">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="content">
                        <div class="blur-bg" style="background-image: url({{ asset('/images/snorkeling.jpg') }});"></div>
                        <h2>SNORKELING</h2>
